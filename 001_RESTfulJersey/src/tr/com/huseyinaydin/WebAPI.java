...
//http://localhost:8080/_001_RESTfulJersey/rest/hello/query3
	@GET 
	@Path("/query3")
	@Produces("text/html")
...
//http://localhost:8080/_001_RESTfulJersey/rest/hello/query4/{myParameter}
	@GET 
...
//http://localhost:8080/_001_RESTfulJersey/rest/hello/query5/{myParameter}
	@GET 
	@Path("/query5")
